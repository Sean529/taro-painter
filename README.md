...
Taro-react 写法的 painter 组件 demo。

因项目需要，基于 [taro-painter](https://github.com/duyanren/taro-painter) 和 [Painter-For-Taro-React](https://github.com/ZacharyQin/Painter-For-Taro-React/blob/master/README.md) 项目修改。
